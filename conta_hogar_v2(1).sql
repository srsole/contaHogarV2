...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 08-09-2016 a las 13:39:42
...
DROP TABLE IF EXISTS `gasto_recurrente`;
...
DROP TABLE IF EXISTS `ingreso_fijo`;
...
DROP TABLE IF EXISTS `ingreso_recurrente`;
...
(2, 'prueba', 'apellido', 'prueba', 'prueba@gamil.com', 'prueba', NULL, NULL, '1987-06-30');
...
(4, 'alumne', 'alumne', 'alumne@gmail.com', '2016-09-08', NULL, 1, 2);
...
--
ALTER TABLE `perfil`
  MODIFY `id_perfil` int(11) NOT NULL AUTO_INCREMENT COMMENT 'el la primary key', AUTO_INCREMENT=3;
--
-- AUTO_INCREMENT de la tabla `user`
--
ALTER TABLE `user`
  MODIFY `id_user` int(11) NOT NULL AUTO_INCREMENT COMMENT 'es la primary key', AUTO_INCREMENT=5;
--
...
ALTER TABLE `cuenta`
  ...
  ADD CONSTRAINT `cuenta_ibfk_2` FOREIGN KEY (`id_moneda`) REFERENCES `moneda` (`id_moneda`);

--
-- Filtros para la tabla `gasto`
--
ALTER TABLE `gasto`
  ADD CONSTRAINT `gasto_ibfk_1` FOREIGN KEY (`id_cuenta`) REFERENCES `cuenta` (`id_cuenta`),
  ADD CONSTRAINT `gasto_ibfk_2` FOREIGN KEY (`id_concepto`) REFERENCES `concepto` (`id_concepto`);

--
-- Filtros para la tabla `gasto_fijo`
--
ALTER TABLE `gasto_fijo`
  ADD CONSTRAINT `gasto_fijo_ibfk_1` FOREIGN KEY (`id_cuenta`) REFERENCES `cuenta` (`id_cuenta`),
  ADD CONSTRAINT `gasto_fijo_ibfk_2` FOREIGN KEY (`id_concepto`) REFERENCES `concepto` (`id_concepto`);

--
-- Filtros para la tabla `gasto_recurrente`
--
ALTER TABLE `gasto_recurrente`
  ADD CONSTRAINT `gasto_recurrente_ibfk_1` FOREIGN KEY (`id_cuenta`) REFERENCES `cuenta` (`id_cuenta`),
  ADD CONSTRAINT `gasto_recurrente_ibfk_2` FOREIGN KEY (`id_concepto`) REFERENCES `concepto` (`id_concepto`);

--
-- Filtros para la tabla `ingreso`
--
ALTER TABLE `ingreso`
  ADD CONSTRAINT `ingreso_ibfk_1` FOREIGN KEY (`id_cuenta`) REFERENCES `cuenta` (`id_cuenta`),
  ADD CONSTRAINT `ingreso_ibfk_2` FOREIGN KEY (`id_concepto`) REFERENCES `concepto` (`id_concepto`);

--
-- Filtros para la tabla `ingreso_fijo`
--
ALTER TABLE `ingreso_fijo`
  ADD CONSTRAINT `ingreso_fijo_ibfk_1` FOREIGN KEY (`id_cuenta`) REFERENCES `cuenta` (`id_cuenta`),
  ADD CONSTRAINT `ingreso_fijo_ibfk_2` FOREIGN KEY (`id_concepto`) REFERENCES `concepto` (`id_concepto`);

--
-- Filtros para la tabla `ingreso_recurrente`
--
ALTER TABLE `ingreso_recurrente`
  ADD CONSTRAINT `ingreso_recurrente_ibfk_1` FOREIGN KEY (`id_cuenta`) REFERENCES `cuenta` (`id_cuenta`),
  ADD CONSTRAINT `ingreso_recurrente_ibfk_2` FOREIGN KEY (`id_concepto`) REFERENCES `concepto` (`id_concepto`);

--
-- Filtros para la tabla `user`
--
ALTER TABLE `user`
  ADD CONSTRAINT `user_ibfk_1` FOREIGN KEY (`id_perfil`) REFERENCES `perfil` (`id_perfil`);
